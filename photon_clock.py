...
class PhotonClock(Scene):
    ...
    def construct(self):
        ...
        # Tick clock
        self.play(Succession([anim for anim in self.tick_clock(photon_clock_obs, 1)]))
        ...
        # Trace
        trace = TracedPath(photon_clock_ship[0].get_center, dissipating_time=0.3, stroke_opacity=[0, 1], color=BLUE)
        self.add(trace)
